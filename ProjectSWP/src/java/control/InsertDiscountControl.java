...
public class InsertDiscountControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!checkInsertDiscount(list, discountPercentage)) {
            List<Discount> listD = dao.getAllDiscount();
    ...
    public boolean checkInsertDiscount(List<Discount> list, double discountPercentage) {
        for (Discount discount : list) {
            if (discount.getDiscountPercentage() == discountPercentage) {
                return false;
            }
        }
        return true;
