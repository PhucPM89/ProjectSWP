...
public class UpdateAttendance extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String attendance_status = request.getParameter("modalStatus");
        
        dao.updateAttendanceByAttendanceID(attendance_status, attendance_id);
        response.sendRedirect("workScheduleControl");
    } 
