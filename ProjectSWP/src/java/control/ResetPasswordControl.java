...
public class ResetPasswordControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (validAdminCode || validEmployeeCode) {
            ...
            request.setAttribute("mess", "Your password has been reset. Please check your email for the new password.");

            // Send email with the new password
            String mess = "Your new password is: " + newPassword;
            String imagePath = "D:\\Studing\\Su24\\SWP\\ProjectSWP\\web\\assets\\img\\logo\\logo.svg";
            mail.send(email, "New Password", mess, imagePath);
