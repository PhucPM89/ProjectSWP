                ...
                <div class="form-container">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="startingCash" placeholder="Enter starting cash amount">
                        </div>
                        <div class="form-group">
                            <label for="endingCash">Ending Cash</label>
                            <input type="number" class="form-control" id="endingCash" placeholder="Enter ending cash amount">
                        </div>
