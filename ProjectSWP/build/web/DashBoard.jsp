...
<html lang="en">
    ...
    $(document).ready(function () {
        Swal.fire({
            ...
            text: 'Tháng này không có giao dịch nào !',
            icon: 'info',
        ...
        <c:if test="${testD && totalTranHis != 0}">
            <script>
                $(document).ready(function () {
        ...
        <script>
            ...
            <c:forEach var="detail" items="${listOrderDetails}">
                ...
                function updateTransactionsPerDayChart(month) {
                    // Chỉ cập nhật biểu đồ nếu month khác tháng hiện tại để tránh tải lại dữ liệu cùng một tháng
                ...
                updateTransactionsPerDayChart(1); // Initialize with January data
            });
        </script>
    </body>
</html>
